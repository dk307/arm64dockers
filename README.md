...
|-----------|----------|-------------|------|
| [`llama-cpp-embed-nomic`](#llama-cpp-embed-nomic) | [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) | nomic-embed-text embedding server | `b10437`, `latest` |
...
docker pull ghcr.io/dk307/llama-cpp-embed-nomic:b10437
```
